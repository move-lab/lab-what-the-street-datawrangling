coil = (function() {
    ...
    function generateSvgPieces(coiledStreets, meterPerPixel, svgHeight, stroke, strokeWidth, streetName, neighborhoodName) {
        stroke = stroke || '#000000' // '#50E3C2';
        var svgPieces = [];
        for (var s = 0; s < coiledStreets.length; s++) {
            var coiledStreet = coiledStreets[s];
            var path = generatePath(coiledStreet, meterPerPixel, stroke, strokeWidth, streetName, neighborhoodName);
            svgPieces.push(path);
        }
    ...
    function generatePath(coiledStreet, meterPerPixel, stroke, strokeWidth, streetName, neighborhoodName) {
        stroke = stroke || '#000000' // '#50E3C2';
